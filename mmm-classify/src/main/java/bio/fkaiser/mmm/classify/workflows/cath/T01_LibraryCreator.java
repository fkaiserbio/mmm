package bio.fkaiser.mmm.classify.workflows.cath;

import bio.fkaiser.mmm.ItemsetMinerRunner;
import bio.fkaiser.mmm.classify.model.ItemsetLibrary;
import bio.fkaiser.mmm.classify.workflows.WorkflowTask;
