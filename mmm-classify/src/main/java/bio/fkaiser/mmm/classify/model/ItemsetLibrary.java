...
public class ItemsetLibrary {
    ...
    /**
     * Creates an {@link ItemsetLibrary} of the {@link Itemset} observations calculated with the {@link AffinityMetric}. The exemplars of each cluster are added to
     * the library for each {@link Itemset}.
     *
     * @param affinityItemsets   The clustered {@link Itemset}s with {@link AffinityMetric} fo which a library should be created.
