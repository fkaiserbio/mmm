...
@JsonSubTypes({@JsonSubTypes.Type(value = ChemicalGroupsMappingRule.class), @JsonSubTypes.Type(value = FunctionalGroupsMappingRule.class), @JsonSubTypes.Type(value = NoAminoAcidsMappingRule.class)})
